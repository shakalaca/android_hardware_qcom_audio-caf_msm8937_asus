                     ...
                     hw_device_t **device)
{
    ...
    *device = &adev->device.common;
    ...
    if (tfa9890_dev.lib_ptr != NULL) {
        tfa9890_dev.exTfa98xx_calibration = (exTfa98xx_calibration_t)dlsym(tfa9890_dev.lib_ptr, "Tfa98xx_calibration");
        tfa9890_dev.exTfa98xx_speakeron = (exTfa98xx_speakeron_t)dlsym(tfa9890_dev.lib_ptr, "Tfa98xx_speakeron");
        tfa9890_dev.exTfa98xx_speakeroff = (exTfa98xx_speakeroff_t)dlsym(tfa9890_dev.lib_ptr, "Tfa98xx_speakeroff");
    } else {
        ALOGE("%s: failed to load tfa98xx library", __func__);
    }
